            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> ISA Scheduling Dashboard
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>GA Design</h3>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                	  <center><img src="<c:url value='/resources/images/GADesign.png' />"  >  </center>                                 
                            	</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>ISA Sensor Design</h3>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                	  <center><img src="<c:url value='/resources/images/ISADesign.png' />"  >  </center>                                 
                            	</div>
                        </div>
                    </div>
                </div>
